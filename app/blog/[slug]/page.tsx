...
const POSTS = [
  {
    ...
    date: '١٥ مايو ٢٠٢٥',
    content: [
      { heading: 'مقدمة', body: 'في عالم يتسارع فيه الابتكار في مجال العناية بالبشرة، تبرز مناديل نَدى الحرير كخيار مثالي للنساء اللواتي يعانين من البشرة الحساسة. فالمنديل ليس مجرد أداة لتجفيف الوجه، بل هو ملامس يومي لبشرتك يستحق الاهتمام الكافي.' },
      { heading: 'نعومة فائقة تحمي البشرة', body: 'الميزة الأولى التي تجعلها متميزة هي درجة نعومتها العالية. تُصنع مناديل نَدى الحرير من ألياف قطنية مختارة بعناية تُخضع لعملية معالجة خاصة تجعلها أكثر ليونة من أي منديل آخر في السوق. لا مزيد من الاحمرار أو التهيج عند استخدام المنديل بعد غسيل الوجه.' },
      { heading: 'مواد طبيعية ١٠٠٪ خالية من المواد الكيميائية', body: 'تخلو مناديل نَدى الحرير من العطور الكيميائية والمواد المضافة الضارة كالفلورين والكلور، مما يجعلها مناسبة تماماً للبشرة الحساسة وبشرة الأطفال. خضعت منتجاتنا لاختبارات مخبرية معتمدة في المملكة العربية السعودية.' },
      { heading: 'معتمدة طبياً للاستخدام اليومي', body: 'تحمل مناديل نَدى الحرير شهادة الاعتماد من هيئة الغذاء والدواء السعودية، كما حصلت على توصية من أطباء الجلدية في عدد من المستشفيات الكبرى. اختيارك لمنتج معتمد يعني أنك في أمان تام.' },
    ],
  },
  {
    ...
    content: [
      ...
      { heading: 'نصائح اقتصادية عند الشراء', body: 'شراء المناديل بالكميات الكبيرة يوفر لك ما يصل إلى ٣٠٪ من التكلفة. استفيدي من عروض نَدى الحرير الأسبوعية والشحن المجاني للطلبات التي تتجاوز ١٥٠ ريال. احرصي على تخزين المناديل في مكان جاف بعيداً عن الرطوبة للحفاظ على جودتها.' },
    ],
  },
  {
    ...
    content: [
      ...
      { heading: 'التزام نَدى الحرير بالاستدامة', body: 'تستخدم نَدى الحرير في منتجاتها نسبة ٧٠٪ من الألياف المعاد تدويرها. عبواتنا مصنوعة من مواد قابلة للتحلل الحيوي ونسعى لتقليل بصمتنا الكربونية في جميع مراحل الإنتاج والتوزيع.' },
  ...
  },
  {
    ...
    date: '١ يونيو ٢٠٢٥',
    content: [
      { heading: 'علب المناديل كجزء من الديكور', body: 'لم تعد علب المناديل مجرد أداة وظيفية، بل أصبحت جزءاً من المشهد الجمالي للمنزل. صُممت عبوات نَدى الحرير بأناقة تجعلها لائقة لأي ركن في منزلك دون الحاجة لإخفائها.' },
  ...
  },
  {
    ...
    content: [
      ...
      { heading: 'مناديل نَدى الحرير للأطفال', body: 'خط منتجات الأطفال من نَدى الحرير مصمم خصيصاً لبشرة الرضيع. تخضع لفحوصات مخبرية صارمة وتحمل شهادة الأمان للأطفال. يمكن استخدامها لتنظيف وجه الطفل ومناطق الحفاض بأمان تام.' },
    ],
  },
  {
    ...
    date: '١٠ يونيو ٢٠٢٥',
    content: [
      { heading: 'لماذا شراء الجملة أذكى اقتصادياً؟', body: 'المناديل منتج استهلاكي يومي. شراؤها بكميات كبيرة يوفر لك من ٢٠٪ إلى ٤٠٪ مقارنة بالشراء الفردي. مع نَدى الحرير، كلما زادت الكمية، كلما انخفض سعر الوحدة وحصلت على قيمة أعلى.' },
      ...
      { heading: 'عروض نَدى الحرير الحصرية', body: 'اشتركي في نشرة نَدى الحرير البريدية لتصلك تنبيهات عروض الجملة قبل الجميع. نقدم خصومات خاصة للعملاء المتكررين تصل إلى ٣٥٪ على الطلبات الكبيرة، مع شحن مجاني للطلبات فوق ٢٠٠ ريال.' },
    ],
  },
]
...
export default function BlogPostPage({ params }: Props) {
  ...
  const shareText = encodeURIComponent(post.titleAr + ' — نَدى الحرير')
          ...
          <div className="flex gap-8 items-start">
            ...
            <article className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-4 mb-8 pb-6 border-b border-primary-100">
                ...
                <div>
                  <p className="font-black text-primary-900 text-sm">فريق نَدى الحرير</p>
